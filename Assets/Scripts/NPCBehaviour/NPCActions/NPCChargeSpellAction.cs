...
[CreateAssetMenu(fileName = "NPCChargeSpellAction", menuName = "AI Commands/Actions/Charge Spell")]
public class NPCChargeSpellAction : NPCAction
{
    ...
    [Header("Action Timings (Pure Determinism)")]
    ...
    public float npcChargeTime = 1.0f;
